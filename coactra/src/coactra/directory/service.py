...
from coactra.directory.domain.member import Member as DomainMember
from coactra.directory.domain.member import MemberKind, MemberStatus
from coactra.directory.domain.organization import Organization
from coactra.directory.domain.seat import Seat as DomainSeat
from coactra.directory.models import Department, MemberStatus as RowStatus, PolicyRef as PolicyRefRow
from coactra.directory.models import Member as MemberRow
from coactra.directory.models import Seat as SeatRow
...
def load_org(tenant: str, *, store: OrgStore) -> Organization | None:
    ...
    for m in d.members:
        ...
        from coactra.directory.domain.permission import Effect
