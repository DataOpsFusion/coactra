...
_LAZY_EXPORTS: dict[str, tuple[str, str]] = {
    ...
    "AsyncOrgStore": ("coactra.team.directory.repository", "AsyncOrgStore"),
    "AsyncPostgresOrgStore": ("coactra.team.directory.repository", "AsyncPostgresOrgStore"),
    ...
    "make_async_org_store": ("coactra.team.directory.factory", "make_async_org_store"),
