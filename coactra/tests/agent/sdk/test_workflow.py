...
async def test_capability_routing_two_steps(team, security_agent, sre_agent):
    ...
    from coactra.agent.sdk.workflow import Workflow, step
...
async def test_approval_pending_step_accessible(team):
    ...
    from coactra.agent.sdk.workflow import Workflow, step, Step
...
def test_playbook_to_dict_from_dict_round_trip():
    ...
    from coactra.agent.sdk.workflow import Playbook, step
...
async def test_playbook_from_yaml_runs(team):
    ...
    from coactra.agent.sdk.workflow import Playbook, Workflow
...
async def test_workflow_from_yaml(team):
    ...
    from coactra.agent.sdk.workflow import Workflow
...
def test_workflow_import_does_not_pull_pydantic_ai():
    """Importing coactra.agent.sdk.workflow must NOT pull pydantic_ai."""
    import importlib
    import coactra.agent.sdk.workflow as wf_mod
