...
from fleetlib.organization.domain.member import Member as DomainMember
from fleetlib.organization.domain.member import MemberKind, MemberStatus
from fleetlib.organization.domain.organization import Organization
from fleetlib.organization.domain.seat import Seat as DomainSeat
from fleetlib.organization.models import Department, MemberStatus as RowStatus
from fleetlib.organization.models import Member as MemberRow
from fleetlib.organization.models import Seat as SeatRow
from fleetlib.organization.repository.store import OrgStore
...
def _tenant_row(org: Organization):
    from fleetlib.organization.models import Tenant
...
def load_org(tenant: str, *, store: OrgStore) -> Organization | None:
    ...
    for m in d.members:
        ...
        from fleetlib.organization.domain.permission import Effect
