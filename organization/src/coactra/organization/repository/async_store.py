"""Async Postgres organization-store facade.
...
provides the shared multi-process persistence; install ``coactra-organization[postgres]``.
"""
...
from coactra.organization.repository.store import (
    ORG_STORE_METHODS,
    Directory,
    OrgStore,
)
