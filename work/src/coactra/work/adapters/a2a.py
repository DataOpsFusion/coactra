...
from coactra.work.adapters._optional import optional_module
from coactra.work.domain.artifacts import Artifact, ArtifactPart
from coactra.work.domain.capabilities import AgentSpec, SkillSpec
