...
from coactra.orchestration.work.domain.capabilities import CapabilityRequirement
from coactra.orchestration.work.domain.events import AuditContext, utc_now
