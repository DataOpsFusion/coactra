...
from coactra.orchestration.work.domain.artifacts import Artifact, ArtifactRef
...
@runtime_checkable
class AtomicWorkStore(Protocol):
    def save_with_event(
        self,
        order: WorkOrder,
        event: EventEnvelope,
        *,
        ...
        """Insert or update an order and persist its audit event atomically."""
        ...
