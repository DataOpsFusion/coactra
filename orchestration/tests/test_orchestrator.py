from coactra.orchestration import Orchestrator, Procedure, Step, WorkOrder, WorkScope
from coactra.orchestration.workflow import RunResult
...
def test_legacy_namespaces_alias_the_canonical_implementations():
    from coactra.orchestration.work import WorkOrder as CanonicalWorkOrder
    from coactra.orchestration.workflow import Procedure as CanonicalProcedure
    from coactra.work import WorkOrder as LegacyWorkOrder
